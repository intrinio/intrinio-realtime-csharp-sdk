...
{
    /// <summary>
    /// A trade message from Cryptoquote
    /// </summary>
    public class CryptoTrade : IQuote
    {
        /// <summary>
        /// The UTC timestamp of when the trade data was last updated
        /// </summary>
        ...
        /// <summary>
        /// Initializes a CryptoTrade
        /// </summary>
        /// <param name="LastUpdated">The UTC timestamp of when the trade data was last updated</param>
        ...
        /// </summary>
        /// <returns>A string representation of the trade</returns>
        public override string ToString()
        {
            return "Intrinio.CryptoTrade(Type: " + this.Type +
